  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-orange-50/90 dark:bg-black/90 backdrop-blur-sm border-b border-orange-100 dark:border-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="p-2 rounded-lg hover:bg-orange-100 dark:hover:bg-gray-800 transition-colors"
        ...
        {/* Dropdown Menu */}
        {isOpen && (
          <div className="absolute right-6 sm:right-6 lg:right-100.5 top-16 bg-white/20 dark:bg-[#0a0a0a]/30 backdrop-blur-2xl rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 py-2 px-2 min-w-[200px]">
